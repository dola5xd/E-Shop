...
function Footer() {
  return (
    <footer className="flex flex-col gap-3  py-24 pt-36 px-20 bg-primary-darkWhite">
      <div className="flex items-center gap-7 w-full py-5">
        <div className="flex flex-col gap-4 w-2/5">
          ...
          <ul
            className="flex items-center gap-4 *:bg-white *:border
               *:border-primary-Black/20 *:rounded-full *:w-10 *:h-10
                  *:flex *:items-center *:justify-center *:cursor-pointer"
          >
            <li className="hover:bg-black [&:hover>button>svg>path]:fill-white duration-500">
        ...
        <div className="flex flex-col gap-4 w-1/5">
          ...
          <ul
            className="pr-6 flex flex-col gap-5 *:
              text-black/60 *:cursor-pointer *:duration-500 hover:*:text-primary-Black"
          >
            <li>About</li>
            <li>Features</li>
            <li>Works</li>
      ...
      <div className="flex items-center justify-between">
        <p>
          ...
          <span className={`${Integralcf.className} underline`}>
            <a href="https://dribbble.com/hamzauix" target="_blank">
              hamzauix
            </a>{" "}
          </span>
          for UI/UX
        ...
        <div className="scale-110">
          <img src="/assets/images/Payments.png" alt="Payments options" />
        </div>
      </div>
    </footer>
  );
