...
function OrderSummary() {
  ...
  return (
    <div className="flex flex-col gap-7 p-6 border border-black/20 rounded min-h-[200px] w-1/2">
      <h1 className="text-3xl font-bold">Order Summary</h1>
      <ul className="pr-5 flex flex-col gap-5 py-5">
        <li>
        ...
        <li className="flex flex-col gap-5">
          ...
          <div className="flex items-center gap-3 w-full">
            <input
              ...
              className="w-full bg-primary-darkWhite rounded-3xl text-lg py-4 px-5 pl-10"
            />
            <span className="absolute translate-x-3 z-30">
              <svg
                width="22"
                height="22"
                viewBox="0 0 22 22"
            ...
            <button className="bg-black duration-500 hover:bg-black/60 text-white text-lg font-bold py-3 px-7 rounded-3xl">
              Apply
            </button>
          </div>
        </li>
        {cart.length > 0 && (
          <li>
            <button
              className="bg-black duration-500 hover:bg-black/60 text-white text-lg font-bold py-4 px-7 rounded-3xl w-full flex items-center gap-4 justify-center [&>span]:duration-1000 [&>span]:hover:translate-x-full"
              onClick={async () => {
