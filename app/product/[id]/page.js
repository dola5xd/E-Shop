...
async function page({ params }) {
  ...
  return (
    <div className="py-10 px-5 lg:px-20 flex flex-col gap-7">
      ...
      <div className="flex flex-col items-center py-10 lg:py-20 gap-3 lg:gap-10">
        <h1 className={`${Integralcf.className} text-xl lg:text-4xl`}>
          You might also like
        </h1>
        <Suspense
          fallback={
